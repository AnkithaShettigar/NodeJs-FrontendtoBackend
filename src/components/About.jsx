 ...
 const About =()=> {
  ...
  return (
    <>
      ...
      <div className="abt">
      <div className="abt1">
      <span className="cross1">The</span>
      ...
      <div className="content">
        ...
        <div className="body">
        <div className='body1'>
        <img src={require('../pics/mask.png')} alt="" className='image1'/>
        ...
        <div className="img3">
        <img src={require('../pics/SS.png')} alt="" className='image3'/>
        </div>
        <div className='small'>
        ...
        <div className="clap">
            ...
            <span className='clap2'>9.3K claps</span>
        </div>
        <hr style={{color:"gray"}}/>
        <div className="man">
           <div className="man1">
           <img src={require('../pics/mask.png')} alt="" />
           </div>
            <div className="man2">
