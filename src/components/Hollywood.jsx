...
const Hollywood = ()=>{
  ...
  useEffect(()=>{
    fetch(`https://nodejs-seven-project.herokuapp.com/home/hollywood`)
    .then(res=>res.json())
    .then(data=>{
      setData(data)
  ...
  mainHolly = data.filter((item)=>item.category==="mainHolly")
  mainFourth = data.filter((item)=>item.category==="mainFourth")
          ...
          <div className="box">
            ...
            <div className="boxleftbolly">
                ...
                <div className="toppost">
                    <Link to={`/pages/about/${45}`}className="two">
                    <div className="Av1"><br />
                    <h1 className="no1">1</h1>
                    <h3 className="top1text">'Marvel Studios' Avengers: Endgame'</h3>
